                                    ...
                                    <a href="{{route('vendor.menu.category',['vendor_slug'=>$vendor_slug,'category_id'=>$category->id])}}" class="categore-box style-1">
                                        <div class="icon-bx bg-primary">
                                            <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M1.02026 14.648C0.984375 14.6425 0.948303 14.6365 0.911499 14.6279C0.948486 14.6365 0.984192 14.6427 1.02026 14.648Z" fill="white"/>
...
{{--                             
                                ...
                                <div class="swiper-slide">
                                    <a href="product.html" class="categore-box style-1">
                                        <div class="icon-bx bg-green">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19.7343 9.1875C19.7343 11.1259 18.1571 12.7031 16.2187 12.7031H7.78122C5.8428 12.7031 4.2656 11.1259 4.2656 9.1875V6.29208L2.11572 7.36721L3.53561 23.0326L6.58099 19.9872L7.57525 20.9815L4.55674 24H19.4432L16.4247 20.9815L17.419 19.9872L20.4643 23.0326L21.8842 7.36721L19.7343 6.29208V9.1875Z" fill="white"/>
                                                <path d="M5.67188 9.1875C5.67188 10.3507 6.61809 11.2969 7.78125 11.2969V0H5.67188V9.1875Z" fill="white"/>
                                                <path d="M18.3281 9.1875V0H16.2188V11.2969C17.3819 11.2969 18.3281 10.3507 18.3281 9.1875Z" fill="white"/>
                                                <path d="M12.7031 4.21875H14.8125V11.2969H12.7031V4.21875Z" fill="white"/>
                                                <path d="M9.1875 2.8125H11.2969V11.2969H9.1875V2.8125Z" fill="white"/>
                                            </svg>
                                        </div>
                    ...
                    <div class="item-box">
                        <div class="item-media">
                            <img src="{{asset('customer/assets/images/food/food3.png')}}" alt="food">
                        </div>
                        <div class="item-content">
	...
	<div class="offcanvas offcanvas-bottom pwa-offcanvas">
		<div class="container">
			<div class="offcanvas-body small">
				<img class="logo" src="{{asset('customer/assets/images/icon.png')}}" alt="">
				<h5 class="title">Foodia on Your Home Screen</h5>
				<p>Install Foodia - Food Restaurant on your home screen, and access it just like a regular app</p>
