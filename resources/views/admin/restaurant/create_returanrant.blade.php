            ...
            <form method="post" action="{{ route('restaurant.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="whatsapp_number" id="inputPassword4" placeholder="whatsapp_number">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="phone_number" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-2">
                    <label for="inputZip">domin name</label>
                        ...
                        <input type="text" name="slug" placeholder="enter your domin name"  class="form-file-input form-control">
